    ...
    <div className="flex flex-wrap gap-2 py-1">
      {heatMapData?.map((d, index) => {
        ...
        return (
          <div
            key={index}
            className="h-7 w-7 rounded-md border border-white/5 transition-all duration-300 hover:scale-105 hover:border-indigo-500/40 hover:shadow-[0_0_8px_rgba(99,102,241,0.2)]"
