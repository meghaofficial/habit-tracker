...
const Calendar = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-start mt-4 mb-3 gap-4 w-full">
      ...
      <Card
        heading=""
        cardWidth={`w-full ${openForm ? "lg:w-[28%]" : "hidden"}`}
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2.5">
                  {Object.entries(statusColors).map(([key, value], index) => {
                    const currentStatus = activeDataList?.id
                      ? activeDataList.status
                      : activeStatus;
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                >
                  ...
                  updateCalendarMutation.isPending ? (
                    ...
                    <>
                      <span>
                        {activeDataList?.id ? "Save Changes" : "Create Task"}
                      </span>
                      {!activeDataList?.id && (
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl text-xs font-bold uppercase tracking-wider p-1.5 flex items-center gap-3 backdrop-blur-md">
                ...
                <span className="w-16 text-center text-purple-100">
                  {monthStr}
                </span>
                <button
                  className="p-1.5 rounded-lg hover:bg-white/10 transition-colors active:scale-95"
