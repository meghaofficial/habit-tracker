      ...
      >
        ...
        <div className="relative z-10 mt-5">
          <textarea
            ...
            className=" h-80 w-full resize-none rounded-2xl border border-white/10 dark:border-black/10 bg-white/3 light:bg-white/3 px-5 py-4 text-[15px] leading-7 text-white outline-none placeholder:text-white/25 shadow-[inset_0_1px_2px_rgba(255,255,255,0.06)] backdrop-blur-xl transition-all duration-300 focus:border-[#8B5CF6]/40 focus:bg-white/5 focus:shadow-[0_0_25px_rgba(139,92,246,0.15)] light:text-lightText light:placeholder:text-lightSubText "
          />
        </div>
